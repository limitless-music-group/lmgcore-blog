...
const bubbleVariants = tv({
  base: "group/bubble relative flex w-fit min-w-0 max-w-[80%] flex-col gap-1 data-[variant=ghost]:max-w-full data-[align=end]:self-end group-data-[align=end]/message:self-end",
  defaultVariants: {
    variant: "default",
  },
...
const bubbleReactionsVariants = tv({
  base: "absolute z-10 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full bg-muted px-1.5 py-0.5 text-xs ring-2 ring-card has-[button]:p-0",
  defaultVariants: {
    align: "end",
    side: "bottom",
  },
